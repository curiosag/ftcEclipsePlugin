...
public abstract class AbstractPreferencePage extends PreferencePage implements ModifyListener, SelectionListener, IWorkbenchPreferencePage {
	...
	protected Preferences getModelPreferences() {
		return null; // TODO SSECorePlugin.getDefault().getPluginPreferences();
	}
	...
	protected void setInvalidInputMessage(String widthText) {
		String msg = ""; // TODONLS.bind(SSEUIMessages._4concat, (new Object[]{widthText}));
		setErrorMessage(msg);
	}
	...
	protected void storeValues() {
		// TODO SSEUIPlugin.getDefault().savePluginPreferences();
	}
